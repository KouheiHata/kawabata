...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-12"><!-- （メイン部分） start-->
                <div class="row">
                    <div class="pop-area">
                        <a href="<?php echo home_url('/hojyokin/'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/pop1.png" class="pop1 fadein" alt="補助金に関する情報はこちら"></a>
                        <a href="<?php echo home_url('/zkuutyou/'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/pop2.png" class="pop2 fadein" alt="Z空調に関する情報はこちら"></a>
                        <a href="<?php echo home_url('/longlife/'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/pop3.png" class="pop3 fadein" alt="長期優良住宅に関する情報はこちら"></a>
                    </div><!-- pop-area -->
                </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 sidebar-option"><!-- サイドバー -->
               ...
               <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 pt-5 pr-3">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 pt-5">
                    ...
                    <iframe class="youtube-video" src="https://www.youtube.com/embed/4-YaOXQMQsw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div><!-- Youtube end -->
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 pt-5">
