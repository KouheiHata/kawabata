...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-12"><!-- （メイン部分） start-->
                <div class="row">
                    <div class="pop-area">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/pop1.png" class="pop1 fadein" alt="補助金に関する情報はこちら">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/pop2.png" class="pop2 fadein" alt="Z空調に関する情報はこちら">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/pop3.png" class="pop3 fadein" alt="長期優良住宅に関する情報はこちら">
                    </div><!-- pop-area -->
                </div>
