    ...
    <div class="container mb-5">
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="pl55">
                    <p class="pt-4"><span class="ls53">居住年</span>：平成26年（4月）から 令和3年（12月末まで）<br>控除期間：10年間<br><span class="ls53">控除率</span>：1.0%</p>
                    <img class="d-block pt-3" src="<?php echo get_template_directory_uri(); ?>/images/LH/lh-7.png" alt="表" width="680px">
                </div>
            </div>
